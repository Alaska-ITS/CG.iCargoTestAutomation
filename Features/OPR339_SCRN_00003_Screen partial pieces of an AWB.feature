Feature: OPR339_SCRN_00003_Screen partial pieces of an AWB

@OPR339_SCRN_00003 @OPR339
Scenario Outline: Create a PP AWB in LTE001 for a known shipper and screen the half slated pieces using OPR339 screen
	...
	Examples:
	| AgentCode | ShipperCode | ConsigneeCode | Origin | Destination | ProductCode | SCC  | Commodity | ShipmentDescription | ServiceCargoClass | Piece | Weight | ChargeType | ModeOfPayment | cartType | Execute | SlatedPieces |
	| 11377     | 11377       | 11377         | SEA    | LAX         | GENERAL     | None | NONSCR    | None                | None              | 10    | 775    | PP         | CREDIT        | CART     | Yes     | 4           |
	| 11377     | 11377       | 11377         | ANC    | HNL         | PRIORITY    | None | 2199      | None                | None              | 8     | 360    | PP         | CREDIT        | CART     | No      | 2           |
	| 11377     | 11377       | 11377         | SAN    | JFK         | GOLDSTREAK  | None | NONSCR    | None                | None              | 2     | 55     | PP         | CREDIT        | CART     | No      | 3           |
	| 11377     | 11377       | 11377         | YVR    | SEA         | PRIORITY    | None | NONSCR    | None                | None              | 5     | 225    | PP         | CREDIT        | CART     | No      | 4           |
