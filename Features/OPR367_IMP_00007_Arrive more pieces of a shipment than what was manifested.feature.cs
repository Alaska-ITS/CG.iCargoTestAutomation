...
namespace iCargoUIAutomation.Features
{
    ...
    [NUnit.Framework.DescriptionAttribute("OPR367_IMP_00007_Arrive more pieces of a shipment than what was manifested")]
    public partial class OPR367_IMP_00007_ArriveMorePiecesOfAShipmentThanWhatWasManifestedFeature
    {
...
#line 1 "OPR367_IMP_00007_Arrive more pieces of a shipment than what was manifested.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "OPR367_IMP_00007_Arrive more pieces of a shipment than what was manifested", "Import a Shipment as a CGO or CGODG user", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.DescriptionAttribute("Arrive more pieces of a shipment than what was manifested")]
        [NUnit.Framework.CategoryAttribute("OPR367")]
        [NUnit.Framework.CategoryAttribute("OPR367_IMP_00007")]
        [NUnit.Framework.TestCaseAttribute("11377", "11377", "11377", "SFO", "LAX", "GOLDSTREAK", "None", "NONSCR", "None", "None", "2", "59", "CC", "None", "PlannedShipment", "1", "CART", "IDEFLOC", "2", "59", "Yes", null)]
        public virtual void ArriveMorePiecesOfAShipmentThanWhatWasManifested(
                    string agentCode, 
                    string shipperCode, 
                    ...
                    string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Arrive more pieces of a shipment than what was manifested", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 6
