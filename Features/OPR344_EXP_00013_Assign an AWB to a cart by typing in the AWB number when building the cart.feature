Feature: OPR344_EXP_00013_Assign an AWB to a cart by typing in the AWB number when building the cart

Manifest a Shipment as a CGO or CGODG user

@OPR344 @OPR344_EXP_00013
Scenario Outline: Assign an AWB to a cart by typing in the AWB number when building the cart
...
Examples:
	...
	| 11377     | 11377       | 11377         | SEA    | JFK         | GENERAL     | None | NONSCR    | None                | None              | 14    | 198    | CC         | None          | PlannedShipment | CART     | Yes     |
