...
namespace iCargoUIAutomation.Features
{
    ...
    [NUnit.Framework.DescriptionAttribute("OPR367_IMP_00003_Unarrive cargo that was arrived in error")]
    public partial class OPR367_IMP_00003_UnarriveCargoThatWasArrivedInErrorFeature
    {
...
#line 1 "OPR367_IMP_00003_Unarrive cargo that was arrived in error.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "OPR367_IMP_00003_Unarrive cargo that was arrived in error", "Import a Shipment as a CGO or CGODG user", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.DescriptionAttribute("Unarrive cargo that was arrived in error")]
        [NUnit.Framework.CategoryAttribute("OPR367")]
        [NUnit.Framework.CategoryAttribute("OPR367_IMP_00003")]
        [NUnit.Framework.TestCaseAttribute("11377", "11377", "11377", "SAN", "SFO", "GOLDSTREAK", "None", "NONSCR", "None", "None", "2", "59", "CC", "None", "PlannedShipment", "CART", "IDEFLOC", "2", "59", "Yes", null)]
        public virtual void UnarriveCargoThatWasArrivedInError(
                    string agentCode, 
                    string shipperCode, 
                    ...
                    string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Unarrive cargo that was arrived in error", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 6
