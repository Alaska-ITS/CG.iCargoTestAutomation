@CAP018
Feature: CAP Booking Tests

@CAP018_BKG_00001 @DataSource:TestData\CSV\CAP018_BKG_00001.csv
...
@CAP018_BKG_00002  @DataSource:TestData\CSV\CAP018_BKG_00002.csv
...
@CAP018_BKG_00003 @DataSource:TestData\CSV\CAP018_BKG_00003.csv
...
@CAP018_BKG_00004 @DataSource:TestData\CSV\CAP018_BKG_00004.csv
...
@CAP018_BKG_00005 @DataSource:TestData\CSV\CAP018_BKG_00005.csv
...
@CAP018_BKG_00006 @DataSource:TestData\CSV\CAP018_BKG_00006.csv
...
@CAP018_BKG_00007 @DataSource:TestData\CSV\CAP018_BKG_00007.csv
...
@CAP018_BKG_00008 @DataSource:TestData\CSV\CAP018_BKG_00008.csv
Scenario Outline: Attach or Detach AWB from a saved booking
	Given User wants to execute the example "<Execute>"
	When User switches station if BaseStation other than "<Origin>"
	When User enters screen name as 'CAP018'
	Then User enters into the  iCargo 'Maintain Booking' page successfully
...
@CAP018_BKG_00009 @DataSource:TestData\CSV\CAP018_BKG_00009.csv
