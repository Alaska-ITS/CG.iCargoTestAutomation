...
namespace iCargoUIAutomation.Features
{
    ...
    [NUnit.Framework.DescriptionAttribute("OPR367_IMP_00004_Arrive partial pieces of a shipment that was wholly manifested")]
    public partial class OPR367_IMP_00004_ArrivePartialPiecesOfAShipmentThatWasWhollyManifestedFeature
    {
...
#line 1 "OPR367_IMP_00004_Arrive partial pieces of a shipment that was wholly manifested.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "OPR367_IMP_00004_Arrive partial pieces of a shipment that was wholly manifested", "Import a Shipment as a CGO or CGODG user", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.DescriptionAttribute("Arrive partial pieces of a shipment that was wholly manifested")]
        [NUnit.Framework.CategoryAttribute("OPR367")]
        [NUnit.Framework.CategoryAttribute("OPR367_IMP_00004")]
        [NUnit.Framework.TestCaseAttribute("11377", "11377", "11377", "SFO", "LAX", "GOLDSTREAK", "None", "NONSCR", "None", "None", "35", "234", "CC", "None", "PlannedShipment", "CART", "IDEFLOC", "15", "112", "Yes", null)]
        public virtual void ArrivePartialPiecesOfAShipmentThatWasWhollyManifested(
                    string agentCode, 
                    string shipperCode, 
                    ...
                    string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Arrive partial pieces of a shipment that was wholly manifested", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 6
