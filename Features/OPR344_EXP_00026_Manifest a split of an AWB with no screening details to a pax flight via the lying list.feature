Feature: OPR344_EXP_00026_Manifest a split of an AWB with no screening details to a pax flight via the lying list


@OPR344_EXP_00026  @OPR344
Scenario: Manifest a split of an AWB with no screening details to a pax flight via the lying list
