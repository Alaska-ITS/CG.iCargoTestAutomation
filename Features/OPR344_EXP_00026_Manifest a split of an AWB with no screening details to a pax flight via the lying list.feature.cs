...
namespace iCargoUIAutomation.Features
{
    ...
    [NUnit.Framework.DescriptionAttribute("OPR344_EXP_00026_Manifest a split of an AWB with no screening details to a pax fl" +
        "ight via the lying list")]
    public partial class OPR344_EXP_00026_ManifestASplitOfAnAWBWithNoScreeningDetailsToAPaxFlightViaTheLyingListFeature
    {
...
#line 1 "OPR344_EXP_00026_Manifest a split of an AWB with no screening details to a pax flight via the lying list.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "OPR344_EXP_00026_Manifest a split of an AWB with no screening details to a pax fl" +
                    "ight via the lying list", null, ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.DescriptionAttribute("Manifest a split of an AWB with no screening details to a pax flight via the lyin" +
            "g list")]
        [NUnit.Framework.CategoryAttribute("OPR344_EXP_00026")]
        [NUnit.Framework.CategoryAttribute("OPR344")]
        [NUnit.Framework.TestCaseAttribute("11377", "11377", "11377", "SEA", "ANC", "GENERAL", "None", "NONSCR", "None", "None", "2", "60", "CC", "None", "173", "LyingList", "CART", "Yes", "1", null)]
        public virtual void ManifestASplitOfAnAWBWithNoScreeningDetailsToAPaxFlightViaTheLyingList(
                    string agentCode, 
                    string shipperCode, 
                    ...
                    string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Manifest a split of an AWB with no screening details to a pax flight via the lyin" +
                    "g list", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 5
...
#line hidden
#line 34
 testRunner.And(string.Format("User selects the Booked AWB from the Lying List, Split And assign with Pieces \"{0" +
                            "}\"", splitPieces), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 35
 testRunner.And("User validates the error message in Check Embargo as \"SCREENING MUST BE COMPLETED" +
                        " FOR MOVEMENT ON PAX AIRCRAFT\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 36
