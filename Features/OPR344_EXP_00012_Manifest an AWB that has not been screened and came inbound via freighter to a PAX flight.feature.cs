...
namespace iCargoUIAutomation.Features
{
    ...
    public partial class OPR344_EXP_00012_ManifestAnAWBThatHasNotBeenScreenedAndCameInboundViaFreighterToAPAXFlightFeature
    {
...
#line 1 "OPR344_EXP_00012_Manifest an AWB that has not been screened and came inbound via freighter to a PAX flight.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "OPR344_EXP_00012_Manifest an AWB that has not been screened and came inbound via " +
                    "freighter to a PAX flight", "Manifest a Shipment as a CGO or CGODG user", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.DescriptionAttribute("Manifest an AWB that has not been screened and came inbound via freighter to a PA" +
            "X flight")]
        ...
        public virtual void ManifestAnAWBThatHasNotBeenScreenedAndCameInboundViaFreighterToAPAXFlight(
                    string agentCode, 
                    string shipperCode, 
                    ...
                    string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Manifest an AWB that has not been screened and came inbound via freighter to a PA" +
                    "X flight", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 6
