...
namespace iCargoUIAutomation.Features
{
    ...
    [NUnit.Framework.DescriptionAttribute("LTE001_ACC_00024_Create an AWB for an unknown shipper with routing wholly within " +
        "SOA")]
    public partial class LTE001_ACC_00024_CreateAnAWBForAnUnknownShipperWithRoutingWhollyWithinSOAFeature
    {
...
#line 1 "LTE001_ACC_00024_Create an AWB for an unknown shipper with routing wholly within SOA.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "LTE001_ACC_00024_Create an AWB for an unknown shipper with routing wholly within " +
                    "SOA", "Create a New Shipment, Acceptance of that new shipment & screening as a CGO or CG" +
        ...
        [NUnit.Framework.DescriptionAttribute("Create an AWB for an unknown shipper with routing wholly within SOA")]
        ...
        public virtual void CreateAnAWBForAnUnknownShipperWithRoutingWhollyWithinSOA(
                    string agentCode, 
                    ...
                    string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Create an AWB for an unknown shipper with routing wholly within SOA", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 6
