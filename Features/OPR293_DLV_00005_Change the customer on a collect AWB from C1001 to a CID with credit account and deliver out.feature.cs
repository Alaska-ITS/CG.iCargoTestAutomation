...
namespace iCargoUIAutomation.Features
{
    ...
    [NUnit.Framework.DescriptionAttribute("OPR293_DLV_00005_Change the customer on a collect AWB from C1001 to a CID with cr" +
        "edit account and deliver out")]
    public partial class OPR293_DLV_00005_ChangeTheCustomerOnACollectAWBFromC1001ToACIDWithCreditAccountAndDeliverOutFeature
    {
...
#line 1 "OPR293_DLV_00005_Change the customer on a collect AWB from C1001 to a CID with credit account and deliver out.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "OPR293_DLV_00005_Change the customer on a collect AWB from C1001 to a CID with cr" +
                    "edit account and deliver out", "A short summary of the feature", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.DescriptionAttribute("Deliver out a CC shipment to a customer with a credit account")]
        [NUnit.Framework.CategoryAttribute("OPR293")]
        [NUnit.Framework.CategoryAttribute("OPR293_DLV_00005")]
        [NUnit.Framework.TestCaseAttribute("11377", "11377", "C1001", "SFO", "SEA", "GOLDSTREAK", "None", "NONSCR", "None", "None", "2", "59", "CC", "None", "PlannedShipment", "CART", "IDEFLOC", "2", "59", "11377", "Yes", null)]
        public virtual void DeliverOutACCShipmentToACustomerWithACreditAccount(
                    string agentCode, 
                    string shipperCode, 
                    ...
                    string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Deliver out a CC shipment to a customer with a credit account", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 6
...
#line hidden
#line 12
 testRunner.And(string.Format("User enters the Participant details with AgentCode \"{0}\", ShipperCode \"{1}\", unkn" +
                            "own ConsigneeCode \"{2}\"", agentCode, shipperCode, consigneeCode), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 13
...
#line hidden
#line 62
 testRunner.And(string.Format("User enters customer code \"{0}\" to process the delivery", customerCode), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 63
