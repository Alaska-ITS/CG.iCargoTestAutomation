...
namespace iCargoUIAutomation.Features
{
    ...
    [NUnit.Framework.DescriptionAttribute("LTE001_ACC_00015_Create an AWB for a CAO DG shipment and book on a pax flight")]
    public partial class LTE001_ACC_00015_CreateAnAWBForACAODGShipmentAndBookOnAPaxFlightFeature
    {
...
#line 1 "LTE001_ACC_00015_Create an AWB for a CAO DG shipment and book on a pax flight.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "LTE001_ACC_00015_Create an AWB for a CAO DG shipment and book on a pax flight", "Create a New DG Shipment, Acceptance & screening of that as a CGODG user", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.TestCaseAttribute("10763", "10763", "10763", "SEA", "ANC", "PRIORITY", "DGR,CAO", "NONSCR", "UN3480", "None", "1", "30", "CC", "None", "CART", "3480", "Lithium ion batteries", "965", "0.5", "No", null)]
                    ...
                    string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Create an AWB for a CAO DG shipment and book on a pax flight", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 6
...
#line 35
 testRunner.And("User validates the popped up error message as \"shipment can be booked only in Car" +
                        "go / truck flight(s)\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 36
