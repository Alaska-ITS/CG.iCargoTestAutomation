...
namespace iCargoUIAutomation.Features
{
    ...
    [NUnit.Framework.DescriptionAttribute("LTE001_ACC_00011_Create an AWB for a known shipper that has first flight on freig" +
        "hter and next flight on pax")]
    public partial class LTE001_ACC_00011_CreateAnAWBForAKnownShipperThatHasFirstFlightOnFreighterAndNextFlightOnPaxFeature
    {
...
#line 1 "LTE001_ACC_00011_Create an AWB for a known shipper that has first flight on freighter and next flight on pax.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "LTE001_ACC_00011_Create an AWB for a known shipper that has first flight on freig" +
                    "hter and next flight on pax", "Create a New Shipment, Acceptance of that new shipment & screening as a CGO or CG" +
                    ...
                    string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Create an AWB for a known shipper that has first flight on freighter and next fli" +
                    "ght on pax", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 6
