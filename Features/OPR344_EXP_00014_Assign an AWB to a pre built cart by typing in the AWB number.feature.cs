...
namespace iCargoUIAutomation.Features
{
    ...
    public partial class OPR344_EXP_00014_AssignAnAWBToAPreBuiltCartByTypingInTheAWBNumberFeature
    {
...
#line 1 "OPR344_EXP_00014_Assign an AWB to a pre built cart by typing in the AWB number.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "OPR344_EXP_00014_Assign an AWB to a pre built cart by typing in the AWB number", "Manifest a Shipment as a CGO or CGODG user", ProgrammingLanguage.CSharp, ((string[])(null)));
...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Type in the AWB number and assign to a pre-built cart")]
        [NUnit.Framework.TestCaseAttribute("SEA", "JFK", "2", "59", "PlannedShipment", "CART", "675", null)]
        public virtual void TypeInTheAWBNumberAndAssignToAPre_BuiltCart(string origin, string destination, string piece, string weight, string aWBSectionName, string cartType, string flightNumber, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Type in the AWB number and assign to a pre-built cart", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 43
this.ScenarioInitialize(scenarioInfo);
#line hidden
            bool isScenarioIgnored = default(bool);
