...
namespace iCargoUIAutomation.Features
{
    ...
    [NUnit.Framework.DescriptionAttribute("OPR344_EXP_00013_Assign an AWB to a cart by typing in the AWB number when buildin" +
        "g the cart")]
    public partial class OPR344_EXP_00013_AssignAnAWBToACartByTypingInTheAWBNumberWhenBuildingTheCartFeature
    {
...
#line 1 "OPR344_EXP_00013_Assign an AWB to a cart by typing in the AWB number when building the cart.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "OPR344_EXP_00013_Assign an AWB to a cart by typing in the AWB number when buildin" +
                    "g the cart", "Manifest a Shipment as a CGO or CGODG user", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.DescriptionAttribute("Assign an AWB to a cart by typing in the AWB number when building the cart")]
        ...
        public virtual void AssignAnAWBToACartByTypingInTheAWBNumberWhenBuildingTheCart(
                    string agentCode, 
                    string shipperCode, 
                    ...
                    string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Assign an AWB to a cart by typing in the AWB number when building the cart", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 6
