Feature: OPR344_EXP_00018_Manifest an AWB for an unknown shipper from the lying list to a pax flight

Manifest a Shipment as a CGO or CGODG user

@OPR344 @OPR344_EXP_00018
Scenario Outline: Manifest an AWB for an unknown shipper from the lying list to a pax flight
...
Examples:
	| AgentCode | UnknownShipperCode | ConsigneeCode | Origin | Destination | ProductCode | SCC  | Commodity | ShipmentDescription | ServiceCargoClass | Piece | Weight | ChargeType | ModeOfPayment | FlightNumber | AWBSectionName | cartType | Execute |
	| ASQXGUEST | C1001              | 11377         | ANC    | OME         | GENERAL     | None | NONSCR    | None                | None              | 2     | 59     | CC         | None          | 155          | LyingList      | CART     | Yes     |
