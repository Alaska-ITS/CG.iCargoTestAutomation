Feature: OPR367_IMP_00003_Unarrive cargo that was arrived in error

Import a Shipment as a CGO or CGODG user

@OPR367 @OPR367_IMP_00003
Scenario Outline: Unarrive cargo that was arrived in error
...
Examples:
	...
	| 11377     | 11377       | 11377         | SAN    | SFO         | GOLDSTREAK  | None | NONSCR    | None                | None              | 2     | 59     | CC         | None          | PlannedShipment | CART     | IDEFLOC  | 2              | 59             | Yes     |
