...
namespace iCargoUIAutomation.Features
{
    ...
    public partial class OPR344_EXP_00004_SplitAnAWBInOPR344AndManifestSplitPiecesToAFlightFeature
    {
...
#line 1 "OPR344_EXP_00004_Split an AWB in OPR344 and manifest split pieces to a flight.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "OPR344_EXP_00004_Split an AWB in OPR344 and manifest split pieces to a flight", "Manifest a Shipment as a CGO or CGODG user", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.DescriptionAttribute("Split an AWB in OPR344 and manifest split pieces to a flight")]
        ...
        public virtual void SplitAnAWBInOPR344AndManifestSplitPiecesToAFlight(
                    string agentCode, 
                    string shipperCode, 
                    ...
                    string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Split an AWB in OPR344 and manifest split pieces to a flight", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 6
