...
namespace iCargoUIAutomation.Features
{
    ...
    public partial class OPR344_EXP_00017_ManifestACAODGFromLyingListToAPaxFlightFeature
    {
...
#line 1 "OPR344_EXP_00017_Manifest a CAO DG from lying list to a pax flight.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "OPR344_EXP_00017_Manifest a CAO DG from lying list to a pax flight", "Create a New DG Shipment, Acceptance & screening of that as a CGODG user", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.DescriptionAttribute("Create an AWB for a CAO DG shipment and book on a Freighter flight")]
        [NUnit.Framework.CategoryAttribute("OPR344")]
        [NUnit.Framework.TestCaseAttribute("10763", "10763", "10763", "ANC", "OME", "PRIORITY", "DGR,CAO", "NONSCR", "UN3480", "None", "1", "30", "CC", "None", "CART", "3480", "Lithium ion batteries", "965", "0.5", "No", null)]
        public virtual void CreateAnAWBForACAODGShipmentAndBookOnAFreighterFlight(
                    string agentCode, 
                    string shipperCode, 
                    ...
                    string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Create an AWB for a CAO DG shipment and book on a Freighter flight", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 5
...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Manifest a CAO DG from lying list to a pax flight")]
        [NUnit.Framework.TestCaseAttribute("ANC", "OME", "155", "1", "30", "LyingList", "CART", null)]
        public virtual void ManifestACAODGFromLyingListToAPaxFlight(string origin, string destination, string flightNumber, string piece, string weight, string aWBSectionName, string cartType, string[] exampleTags)
        {
            ...
            argumentsOfScenario.Add("cartType", cartType);
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Manifest a CAO DG from lying list to a pax flight", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 44
this.ScenarioInitialize(scenarioInfo);
#line hidden
            bool isScenarioIgnored = default(bool);
