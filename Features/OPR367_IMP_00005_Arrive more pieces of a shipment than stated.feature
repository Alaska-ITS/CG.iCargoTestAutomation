Feature: OPR367_IMP_00005_Arrive more pieces of a shipment than stated

Import a Shipment as a CGO or CGODG user

@OPR367 @OPR367_IMP_00005
Scenario Outline: Arrive more pieces of a shipment than stated
	...
	Then User validates the popup warning message as 'Total Received Pcs/Wt is greater than the stated Pcs/Wt for the AWB'
...
Examples:
	...
	| 11377     | 11377       | 11377         | SFO    | LAX         | GOLDSTREAK  | None | NONSCR    | None                | None              | 35    | 234    | CC         | None          | PlannedShipment | CART     | IDEFLOC  | 45             | 245            | Yes     |
