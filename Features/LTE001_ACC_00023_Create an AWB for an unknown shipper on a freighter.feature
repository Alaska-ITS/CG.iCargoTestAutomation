Feature: LTE001_ACC_00023_Create an AWB for an unknown shipper on a freighter

Create a New Shipment, Acceptance of that new shipment & screening as a CGO or CGODG user

@LTE001 @LTE001_ACC_00023
Scenario Outline: Create an AWB for an unknown shipper on a freighter
...
Examples:
	...
	| ASQXGUEST | C1001              | 11377         | SEA    | ANC         | GENERAL     | None | NONSCR    | None                | None              | 13    | 775    | CC         | None          | CART     | Yes     |
