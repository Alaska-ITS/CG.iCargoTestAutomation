...
namespace iCargoUIAutomation.Features
{
    ...
    public partial class OPR344_EXP_00011_ManifestAnAWBThatHasNotBeenScreenedAndCameInboundViaFreighterToAFreighterFeature
    {
...
#line 1 "OPR344_EXP_00011_Manifest an AWB that has not been screened and came inbound via freighter to a freighter.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "OPR344_EXP_00011_Manifest an AWB that has not been screened and came inbound via " +
                    "freighter to a freighter", "Manifest a Shipment as a CGO or CGODG user", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.DescriptionAttribute("Manifest an AWB that has not been screened and came inbound via freighter to a fr" +
            "eighter")]
        ...
        [NUnit.Framework.TestCaseAttribute("11377", "11377", "11377", "ANC", "OME", "PRIORITY", "None", "2199", "None", "None", "10", "287", "CC", "None", "PlannedShipment", "CART", "Yes", null)]
        public virtual void ManifestAnAWBThatHasNotBeenScreenedAndCameInboundViaFreighterToAFreighter(
                    string agentCode, 
                    string shipperCode, 
                    ...
                    string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Manifest an AWB that has not been screened and came inbound via freighter to a fr" +
                    "eighter", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 6
