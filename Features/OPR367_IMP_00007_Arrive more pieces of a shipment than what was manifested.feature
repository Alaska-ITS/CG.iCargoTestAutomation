Feature: OPR367_IMP_00007_Arrive more pieces of a shipment than what was manifested

Import a Shipment as a CGO or CGODG user

@OPR367 @OPR367_IMP_00007
Scenario Outline: Arrive more pieces of a shipment than what was manifested
...
Examples:
	| AgentCode | ShipperCode | ConsigneeCode | Origin | Destination | ProductCode | SCC  | Commodity | ShipmentDescription | ServiceCargoClass | Piece | Weight | ChargeType | ModeOfPayment | AWBSectionName  | SplitPieces | cartType | Bdn_Locn | Bdn_RcvdPieces | Bdn_RcvdWeight | Execute |
	| 11377     | 11377       | 11377         | SFO    | LAX         | GOLDSTREAK  | None | NONSCR    | None                | None              | 2     | 59     | CC         | None          | PlannedShipment | 1           | CART     | IDEFLOC  | 2              | 59             | Yes     |
