Feature: OPR293_DLV_00005_Change the customer on a collect AWB from C1001 to a CID with credit account and deliver out

A short summary of the feature

@OPR293 @OPR293_DLV_00005
Scenario Outline: Deliver out a CC shipment to a customer with a credit account
	...
	And User enters the Participant details with AgentCode "<AgentCode>", ShipperCode "<ShipperCode>", unknown ConsigneeCode "<ConsigneeCode>"
	...
	And User enters customer code "<CustomerCode>" to process the delivery
...
Examples:
	| AgentCode | ShipperCode | ConsigneeCode | Origin | Destination | ProductCode | SCC  | Commodity | ShipmentDescription | ServiceCargoClass | Piece | Weight | ChargeType | ModeOfPayment | AWBSectionName  | cartType | Bdn_Locn | Bdn_RcvdPieces | Bdn_RcvdWeight | CustomerCode | Execute |
	| 11377     | 11377       | C1001         | SFO    | SEA         | GOLDSTREAK  | None | NONSCR    | None                | None              | 2     | 59     | CC         | None          | PlannedShipment | CART     | IDEFLOC  | 2              | 59             | 11377        | Yes     |
