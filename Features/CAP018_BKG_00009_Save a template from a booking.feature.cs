...
namespace iCargoUIAutomation.Features
{
    ...
    public partial class CAP018_BKG_00009_SaveATemplateFromABookingFeature
    {
...
#line 1 "CAP018_BKG_00009_Save a template from a booking.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "CAP018_BKG_00009_Save a template from a booking", null, ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.TestCaseAttribute("SEA", "MCO", "PRIORITY", "NONSCR", "4", "180", "No", "10763", "10763", "10763", null)]
        [NUnit.Framework.TestCaseAttribute("SEA", "DFW", "GENERAL", "NONSCR", "31", "4340", "No", "10763", "10763", "10763", null)]
        public virtual void SaveATemplateFromABooking(string origin, string destination, string productCode, string commodity, string piece, string weight, string execute, string agentCode, string shipperCode, string consigneeCode, string[] exampleTags)
        {
