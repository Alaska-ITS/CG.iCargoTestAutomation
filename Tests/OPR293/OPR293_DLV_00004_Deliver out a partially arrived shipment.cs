...
{
    public class OPR293_DLV_00004_Deliver_out_a_partially_arrived_shipment : IClassFixture<TestFixture>
    {
        ...
        public static IEnumerable<object[]> TestData_OPR293_0004 => ExcelFileDataReader.GetData(BasePage.GetTestDataPath("OPR293_DeliveryDocumentation_TestData.xlsx"), "OPR293_DLV_00004");

        public OPR293_DLV_00004_Deliver_out_a_partially_arrived_shipment(TestFixture fixture)
        {
        ...
        [Trait("Category", "OPR293_DLV_00004")]
        [MemberData(nameof(TestData_OPR293_0004))]

        public void Deliveroutapartiallyarrivedshipment(
            ...
            string cartType, string bdnLocation, string bdnRcvdPcs, string bdnRcvdWt)
        {
            try
            {
                Console.WriteLine("🔹 Starting test:OPR293_DLV_00004_Deliver_out_a_partially_arrived_shipment");
