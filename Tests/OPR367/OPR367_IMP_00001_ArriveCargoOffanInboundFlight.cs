...
{
    public class OPR367_IMP_00001_ArriveCargoOffanInboundFlight : IClassFixture<TestFixture>
    {
        ...
        public static IEnumerable<object[]> TestData_OPR367_0001 => ExcelFileDataReader.GetData(BasePage.GetTestDataPath("OPR367_ImportManifest_TestData.xlsx"), "OPR367_IMP_00001");

        public OPR367_IMP_00001_ArriveCargoOffanInboundFlight(TestFixture fixture)
        {
        ...
        [Trait("Category", "OPR367_IMP_00001")]
        [MemberData(nameof(TestData_OPR367_0001))]

        public void ArriveCargoOffanInboundFlightforOPR367(
            ...
            string cartType,string bdnLocation, string bdnRcvdPcs, string bdnRcvdWt)
        {
            try
            {
                Console.WriteLine("🔹 Starting test:OPR367_IMP_00001_ArriveCargoOffanInboundFlight");
