...
{
    public class OPR367_IMP_00003_Unarrive_cargo_that_was_arrived_in_error : IClassFixture<TestFixture>
    {
        ...
        public static IEnumerable<object[]> TestData_OPR367_0003 => ExcelFileDataReader.GetData(BasePage.GetTestDataPath("OPR367_ImportManifest_TestData.xlsx"), "OPR367_IMP_00003");

        public OPR367_IMP_00003_Unarrive_cargo_that_was_arrived_in_error(TestFixture fixture)
        {
        ...
        [Trait("Category", "OPR367_IMP_00003")]
        [MemberData(nameof(TestData_OPR367_0003))]

        public void Unarrivecargothatwasarrivedinerror(
            ...
            string cartType,string bdnLocation, string bdnRcvdPcs, string bdnRcvdWt)
        {
            try
            {
                Console.WriteLine("🔹 Starting test:OPR367_IMP_00003_Unarrive_cargo_that_was_arrived_in_error");
