...
namespace iCargoUIAutomation.Tests.LTE001
{
    ...
    public class LTE001_ACC_00011_Create_an_AWB_for_a_known_shipper_that_has_first_flight_on_freighter_and_next_flight_on_pax : IClassFixture<TestFixture>
    {
        ...
        public static IEnumerable<object[]> TestData_LTE_00011 => ExcelFileDataReader.GetData(BasePage.GetTestDataPath("LTE001_CreateShipment_TestData_18Apr.xlsx"), "LTE001_ACC_00011");

        public LTE001_ACC_00011_Create_an_AWB_for_a_known_shipper_that_has_first_flight_on_freighter_and_next_flight_on_pax(TestFixture fixture)
        {
        ...
        [Trait("Category", "LTE001_ACC_00011")]
        [MemberData(nameof(TestData_LTE_00011))]
...
)
        {
            try
            {
                ...
                csp.BookConnectingFlightWithDifferentFlightTypes("Cargo-Only", "Combination");
