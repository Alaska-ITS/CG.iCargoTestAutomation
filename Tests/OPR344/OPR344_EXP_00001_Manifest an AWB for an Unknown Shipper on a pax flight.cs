...
namespace iCargoXunit.Tests.OPR344
{
    public class OPR344_EXP_00001_Manifest_an_AWB_for_an_Unknown_Shipper_on_a_pax_flight : IClassFixture<TestFixture>
    {
        ...
        public static IEnumerable<object[]> TestData_OPR344_0001 => ExcelFileDataReader.GetData(BasePage.GetTestDataPath("CAP018_MaintainBooking_TestData.xlsx"), "CAP018_BKG_00001");
        ...
        public void OPR344_EXP_00001_Manifest_An_AWB_For_An_Unknown_Shipper_on_Pax_Flight(
                       string agent, string unknownShipper, string consignee, string origin, string destination, string productCode, string commodity, string piece,
                        string scc, string weight, string shipmentdesc, string serviceCargoClass, string chargeType, string modeOfPayment, string cartType,
