...
{
    public class OPR344_EXP_00020_Manifest_a_CAO_DG_on_a_freighter : IClassFixture<TestFixture>
    {
        ...
        public static IEnumerable<object[]> TestData_OPR344_00020 => ExcelFileDataReader.GetData(BasePage.GetTestDataPath("OPR344_ExportManifest_TestData.xlsx"), "OPR344_EXP_00020");

        public OPR344_EXP_00020_Manifest_a_CAO_DG_on_a_freighter(TestFixture fixture)
        {
            ...
            fogsQAPage = pageObjectManager.GetFogsQAPage();
        }
        ...
        public void ManifestaCAODGonafreighter(
              ...
              string shipmentdesc, string serviceCargoClass, string piece,
               ...
               string pi, string netqtyperpkg, string reportable,
                string awbSectionName, string cartType,string stationCode,string handlingCode)
        {
            try
            {
                Console.WriteLine("🔹 Starting test: OPR344_EXP_00020_Manifest_a_CAO_DG_on_a_freighter");
