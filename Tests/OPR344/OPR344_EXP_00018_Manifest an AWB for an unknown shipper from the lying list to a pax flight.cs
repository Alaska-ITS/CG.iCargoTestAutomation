...
{
    public class OPR344_EXP_00018_Manifest_an_AWB_for_an_unknown_shipper_from_the_lying_list_to_a_pax_flight : IClassFixture<TestFixture>
    {
        ...
        public static IEnumerable<object[]> TestData_OPR344_00018 => ExcelFileDataReader.GetData(BasePage.GetTestDataPath("OPR344_ExportManifest_TestData.xlsx"), "OPR344_EXP_00018");

        public OPR344_EXP_00018_Manifest_an_AWB_for_an_unknown_shipper_from_the_lying_list_to_a_pax_flight(TestFixture fixture)
        {
        ...
        [Trait("Category", "OPR344_EXP_00018")]
        [MemberData(nameof(TestData_OPR344_00018))]

        public void ManifestanAWBforanunknownshipperfromthelyinglisttoapaxflight(
              ...
              string shipmentdesc, string serviceCargoClass, string piece,
               string weight, string chargeType, string modeOfPayment,
                string fltnumber, string awbSectionName,string cartType)
        {
            try
            {
                Console.WriteLine("🔹 Starting test: OPR344_EXP_00018_Manifest_an_AWB_for_an_unknown_shipper_from_the_lying_list_to_a_pax_flight");
