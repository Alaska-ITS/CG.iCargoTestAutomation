    ...
    public class MaintainBookingPage : BasePage
    {
        ...
        public void EnterAWBNumber()
        {
            ...
            try
            {
                ...
                WaitForElementToBeClickable(awbTextbox_ID, TimeSpan.FromSeconds(10));
                Click(awbTextbox_ID);
        ...
        public void ClickSelectSaveTemplate()
        {
            ...
            SwitchToCAP018Frame();
            Log.Info("Switched to CAP018 frame"); 
            EnterText(templateName_XPATH, "Test");
            Click(finalSaveTemplateBtn_XPATH);
        ...
        public void SelectTemplate()
        {
            ClickSelectTemplate();
            SwitchToCAP018Frame();
            WaitForElementToBeInvisible(saveTemplateBtn_XPATH, TimeSpan.FromSeconds(5));            
